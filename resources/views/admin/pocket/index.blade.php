...
@section('content-header')
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View Pockets</li>
      </ol>
@endsection
...
@section('content')
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">All pockets</h3>
...
<script type="text/javascript">
        ...
        $('#data thead th').each( function () {
            if($(this).index()  < 3 && $(this).index()  != 2){
                ...
                $(this).html( '<select><option value=""> All </option><option value="0"> Public </option><option value="1"> Protected </option></option><option value="2"> Private </option></select>' );
            }
        ...
        var table = $('#data').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ url('/adminpanel/pockets/data') }}',
            columns: [
                {data: 'name', name: 'name'},
