...
@section('content')
    <div class="box">
            <div class="box-header">
              ...
              <a href="{{ url('/adminpanel/links/trash') }}" class="btn btn-danger pull-right" ><i class="fa fa-trash-o"></i> Trash</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script type="text/javascript">
        ...
        var table = $('#data').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ url('/adminpanel/links/data') }}',
            columns: [
                {data: 'title', name: 'title'},
                {data: 'pocket_id', name: 'pocket_id'},
